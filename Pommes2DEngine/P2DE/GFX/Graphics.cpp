#include "Graphics.h"
	...
	void Graphics::DrawCircle(float x, float y, float radius, const P2DE_COLOR4 color, float strokeWidth)
	{
	}
	...
	void Graphics::DrawFilledCircle(float x, float y, float radius, const P2DE_COLOR4 color)
	{

	}

	void Graphics::DrawRectangle(const P2DE_RECTF destinationRect, float r, float g, float b, float a, float strokeWidth)
	{
		
	}

	void Graphics::DrawRectangle(const P2DE_RECTF destinationRect, const P2DE_COLOR4 color, float strokeWidth)
	{
		
	}

	void Graphics::DrawFilledRectangle(const P2DE_RECTF destinationRect, float r, float g, float b, float a)
	{

	}

	void Graphics::DrawFilledRectangle(const P2DE_RECTF destinationRect, const P2DE_COLOR4 color)
	{
